...
If you check out this folder, it is assumed that you are about to edit the source code.
...
Important : Please DO NOT touch autogen.xml, this is used to package the project to a plugin zip file. And it is used by build.xml internally.
	    ...
	    You must designate the Eclipse Home, which you can set through "<property name="ECLIPSE_HOME" value="set Eclipse Home here"/>".
